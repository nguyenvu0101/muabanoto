<?php
// HTTP
define('HTTP_SERVER', 'http://www.hyundai4svn.com/admin/');
define('HTTP_CATALOG', 'http://www.hyundai4svn.com/');

// HTTPS
define('HTTPS_SERVER', 'http://www.hyundai4svn.com/admin/');
define('HTTPS_CATALOG', 'http://www.hyundai4svn.com/');
...
define('DB_USERNAME', 'hyundaishop');
define('DB_PASSWORD', 'u4Ij4m_6');
define('DB_DATABASE', 'shophyundai');
define('DB_PREFIX', 'oc_');
define('DB_USERNAME', 'root');
define('DB_PASSWORD', '');
define('DB_DATABASE', 'huyndaishop');
define('DB_PREFIX', 'oc_');
