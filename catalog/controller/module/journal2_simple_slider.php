    ...
    public function index($setting) {
        ...
        if ($cache === null || self::$CACHEABLE !== true) {
                ...
                case 'content_bottom':
                    ...
                    if (Journal2Cache::$mobile_detect->isMobile() && !Journal2Cache::$mobile_detect->isTablet() && $this->journal2->settings->get('responsive_design')) {
                        ...
                        if ($this->journal2->settings->get('extended_layout')) {
                            ...
                            $width = $this->journal2->settings->get('site_width', 1024) - ($cl * $column_left_width + $cl * $content_padding_left) - ($cr * $column_right_width + $cr * $content_padding_right) - ($cl * $content_padding_left + $cr * $content_padding_right);
                        }
            ...
            $this->data['js_options'] = array(
                ...
                'pagination'           => $this->data['bullets'] ? '.swiper-pagination' : '',
